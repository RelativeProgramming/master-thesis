...
export async function createDecoratorNode(deco: LCEDecorator, neo4jSession: Session, connectionIndex: ConnectionIndex, parentNode: Integer, connectionProps: ConnectionProperties): Promise<void> {
